<template>
  <div class="mx-auto mb-20 max-w-7xl">
    <div class="grid grid-cols-12 gap-8 card card-body">
      <Form
        @submit="submitForm"
      ...
      >
        <InputComponent
          ...
          v-model="form.title"
          hint="Use a very hardly title that people could identify your project"
        />
        <InputComponent
        ...
        <button class="w-full btn btn-primary" type="submit">Publish your project</button>
      </form>
...
import InputComponent from "./atoms/InputComponent.vue";
